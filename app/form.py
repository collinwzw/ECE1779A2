...
class ConfigForm(FlaskForm):
    ...
    cooling_time = IntegerField('Cooling Time',validators=[DataRequired(),number_range(max=1000, min=1, message='Please input int 1-1000')])
    cpu_up_threshold = IntegerField('CPU Upper Threshold', validators=[DataRequired(),number_range(max=100, min=1, message='Please input int 1-100')])
    cpu_down_threshold = IntegerField('CPU Down Threshold', validators=[DataRequired(),number_range(max=99, min=0, message='Please input int 0-99')])
