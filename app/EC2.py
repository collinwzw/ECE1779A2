...
'''
    ...
    Modify the function ec2_examples.ec2_list so that display information only
    for instances with the selected status.  

    Documentation for the EC2 filter function is available at:

        https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/ec2.html

    Search in the above URL for the string "ec2.instances.filter"
